...
module.exports.run = async (client, message, args) => {
  ...
  if(!["845953439388532746"].some(role => message.member.roles.cache.get(role)) && (!message.member.hasPermission("ADMINISTRATOR"))) 
...
return {
    ...
    '9': (client.config.sayı9)}[d];})}
         ...
         const embed1 = new Discord.MessageEmbed()
            ...
            .setDescription(`<a:tag:851751408318808084> Sunucuda toplam **${toplamuye}** üye bulunmakta.
            <a:tag:851751408318808084> Sunucuda **${cevirimici}** aktif üye bulunmakta.
            <a:tag:851751408318808084> Sunucuda toplam tagımızı alan **${taglılar}** üye bulunmakta.
            <a:tag:851751408318808084> Sunucuda sesli sohbetlerde toplam **${sessayı}** üye bulunmakta`)
